OutsideLive = {
  ...
  setMinutesRemaining: function(stage) {
    ...
    console.log("WHERE THE END TIME");
    console.log(endTime);
  ...
  setLength: function(stage) {
    var currentPerformance = OutsideLive.currentPerformance(stage.name);
    console.log(OutsideLive.currentPerformance(stage.name));
  ...
  setPercentageRemaining: function(stage) {
  ...
  currentPerformance: function(stage) {
    ...
    for(var i = 0; i < Performances.find().count(); i++) {
      if(performances[i].stage.name === stage){
